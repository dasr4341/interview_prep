...
export enum Node_Events {
  SPECIAL_REPORT_429 = 'special_report_429',
}
...
export enum Sentry_Env {
  production = 'production',
  staging = 'staging',
  development = 'development',
}

export enum LAMBDA_SECRET_NAME {
  production = 'production/pretaa-health-report',
  staging = 'staging/pretaa-health-report',
  development = 'development/pretaa-health-report',
}
