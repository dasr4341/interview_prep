...
load_dotenv()
application_host    = os.getenv(key = 'APPLICATION_HOST', default = '0.0.0.0')
application_port    = int(os.getenv(key = 'APPLICATION_PORT', default = 1234))
application_workers = int(os.getenv(key = 'WORKERS', default = 1))
batch_size          = int(os.getenv(key = 'BATCH_SIZE', default = 5))
