...
function LoadingIcon({ style, outerStyle }: { style: string, outerStyle:string }) {
  return (
    <svg className={style} xmlns='http://www.w3.org/2000/svg' viewBox='0 0 120 206' preserveAspectRatio='none'>
      <path
        className='middle'
