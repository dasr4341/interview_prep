...
import { basalEnergyBurnedModelGenerator, BasalEnergyBurnedModel } from "../../models/activities-model/basalEnergyBurned.model.js";

export default class BasalEnergyBurnedController {
  async basalEnergyBurnedDate(req: Request | any, res: Response, next: NextFunction) {
    try {
      if (!req?.params?.stDate) {
        throw new Exception(
          messagesData.errorList.heart.improperFields,
      ...
      const response = await basalEnergyBurnedModel.aggregate([
  ...
  async basalEnergyBurnedDateRange(req: Request | any, res: Response, next: NextFunction) {
    try {
  ...
  async basalEnergyBurnedIntraday(req: Request | any, res: Response, next: NextFunction) {
    try {
      if (!req?.params?.stDate && !req?.params?.enDate) {
        throw new Exception(
          messagesData.errorList.heart.improperFields,
