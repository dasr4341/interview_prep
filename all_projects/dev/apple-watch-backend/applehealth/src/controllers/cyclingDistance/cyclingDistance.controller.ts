...
import { CyclingDistanceModel, cyclingDistanceModelGenerator } from "../../models/activities-model/cyclingDistance.model.js";

export default class CyclingDistanceController {
  async cyclingDistanceDate(req: Request | any, res: Response, next: NextFunction) {
    try {
      ...
      const response = await cyclingDistanceModel.aggregate([
  ...
  async cyclingDistanceDateRange(req: Request | any, res: Response, next: NextFunction) {
    try {
  ...
  async cyclingDistanceIntraday(req: Request | any, res: Response, next: NextFunction) {
    try {
      if (!req?.params?.stDate && !req?.params?.enDate) {
        throw new Exception(
          messagesData.errorList.heart.improperFields,
