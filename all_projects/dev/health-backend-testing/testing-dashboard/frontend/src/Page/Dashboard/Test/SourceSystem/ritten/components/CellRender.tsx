...
function getValue(value: any, props: CellRenderInterface) {
...
export default function CellRender(props: CellRenderInterface) {
  ...
  } else if ( props?.data?.errors && props.colName && props.colName?.toLowerCase() === 'source' && props.value === DataSourceEnum.RITTEN) {
  ...
  const value = getValue(props.value, props);
