...
describe('Companies privilege check', () => {
  ...
  it('Disable Companies VIEW Role Capabilities for Ticket and verify UI', () => {
  ...
  it('Enable companies VIEW Role Capabilities for Ticket and verify UI', () => {
    ...
    cy.get('[data-test-id="company-list-link"]').click();
    cy.get('[data-test-id="Tickets-link"]').click();
    cy.waitForNetworkIdle(2000);
    companyPage.pageTitle().should('contain.text', `Abbott - Lubowitz Similar's Tickets`);
  });
