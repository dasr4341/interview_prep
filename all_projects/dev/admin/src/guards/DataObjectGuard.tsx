...
const DataObjectGuard = () => {
  ...
  return user &&
    findCurrentPermission(UserPermissionNames.DATA_OBJECT_COLLECTIONS, user?.pretaaGetCurrentUserPermission)
      ?.capabilities.VIEW ? (
    <Outlet />
  ) : (
...
export default DataObjectGuard;
